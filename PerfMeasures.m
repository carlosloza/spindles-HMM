function [PerfTest, PerfTestAlt] = PerfMeasures(labelsGT, labelsPred, Fs)

[CM, CMevent] = ConfusionMatrixSpindles(labelsGT, labelsPred, Fs);
...
PerfTest = [F1 MCC FPProp]';
PerfTestAlt = [TPRalt FPRalt FPPropalt]';
