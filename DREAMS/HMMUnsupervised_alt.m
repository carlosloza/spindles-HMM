...
%     % Learn actual model
%     Durtemp = HMModel.DurationParameters;
%     Durtemp = rmfield(Durtemp, 'PNonParametric');
%     HMModel.DurationParameters = Durtemp;
    
    %HMModel = rmfield(HMModel.DurationParameters, 'PNonParametric');
